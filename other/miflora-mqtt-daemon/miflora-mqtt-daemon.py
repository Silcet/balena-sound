...
parameters = OrderedDict([
    (MI_LIGHT, dict(name="LightIntensity", name_pretty='Sunlight Intensity', typeformat='%d', unit='lx', device_class="illuminance")),
...
if reporting_mode == 'mqtt-json':
    ...
    for [flora_name, flora] in flores.items():
        ...
        mqtt_client.publish('{}/light/$unit'.format(topic_path), 'lx', 1, True)
    ...
    for [flora_name, flora] in flores.items():
        ...
        mqtt_client.publish('{}/light/meta/units'.format(topic_path), 'lx', 1, True)
